      ...
      {showHelp && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full">
            <div className="p-6 border-b flex items-center justify-between" style={{ borderColor: '#C8C8D0', backgroundColor: '#06006E' }}>
            ...
            <div className="p-6">
              <p className="mb-6" style={{ color: '#06006E' }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {shortcuts.map((shortcut, index) => (
                  ...
                  >
                    <span style={{ color: '#06006E' }}>{shortcut.description}</span>
                    <kbd
                      className="px-3 py-1 rounded font-mono text-sm font-semibold"
                      style={{ backgroundColor: '#06006E', color: 'white' }}
                    >
                      {shortcut.key}
                    </kbd>
                  </div>
              ...
              <div className="mt-6 p-4 rounded-lg" style={{ backgroundColor: '#FFE6E6' }}>
                <p className="text-sm" style={{ color: '#E60000' }}>
                  💡 <strong>Astuce :</strong> Appuyez sur <kbd className="px-2 py-1 rounded bg-white font-mono text-xs">Alt + ?</kbd> à tout moment pour afficher cette aide
                </p>
              </div>
            </div>

            <div className="p-6 border-t flex justify-end" style={{ borderColor: '#C8C8D0' }}>
              <button
                onClick={() => setShowHelp(false)}
